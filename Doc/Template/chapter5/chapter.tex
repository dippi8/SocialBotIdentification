...
\end{itemize}
The algorithm were used together into a pipeline work-flow, whose first step is the detection of bots from humans, thanks to the first binary Random Forest.
...
Since this classifier was built for a different purpose, with respect of the multi-class models, the \textit{Area Under the Curve} score (AUC) is the metric we followed, both for baselines and the final model evaluation.
