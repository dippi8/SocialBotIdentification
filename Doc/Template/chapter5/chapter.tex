...
The AUC obtained is equal to 0.935, which is a positive accomplishment, in comparison with the one claimed by the Botometer group, which dedicated its work on this binary separations and that disposed of a largest amount of data, features and models.
