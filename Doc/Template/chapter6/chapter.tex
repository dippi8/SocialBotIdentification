...
We didn't wanted to blindly select this model over some others tool, especially over Random Forest, which proved us to perform well in multi-class classifications.
...
\begin{enumerate}
	...
	\item Prepare data and perform features engineering to output multi-class probability prediction (\textbf{All-features multi-class Random Forest})
