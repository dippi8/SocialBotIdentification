...
This is the reason for the 2 upcoming features. We've found a small versatile project on GitHub (LINK) for NSFW detection.\\
...
For time complexity reasons, we couldn't imagine to scan all the retrieved tweets for each user and to look for a media. We limited the process to the latest ten tweets.\\
