...
After the dictionaries were filtered to prevent (partial) overlapping, we had four collections, composed by the tuples \textit{(word, score)}:
\small
\begin{center}
	\begin{tabular}{ll}
		\\dictionary&size\\
		\hline\hline
		NSFW\_main\_words.csv&1000\\
		spam\_bots\_main\_words.csv&1000\\
		news\_spreders\_main\_words.csv&1000\\
		fake\_followers\_main\_words.csv&1000\\\hline\\
	\end{tabular}
\end{center}
\normalsize
...
Making a step back, before the overall computation of the features, we had to decide the portions of the dictionaries that weren't supposed to overlap with each others.
...
\begin{itemize}
	...
	\textbf{7.} news\_spreaders\_words\_score, \textbf{13.} NSFW\_words\_score, \textbf{15.} spam\_bots\_words\_score, \textbf{23.} fake\_followers\_words\_score.
	
	\item[\PencilRight]500 words in the Safe Area - overall ranking placement:\\
	\textbf{8.} news\_spreaders\_words\_score, \textbf{10.} NSFW\_words\_score, \textbf{16.} spam\_bots\_words\_score, \textbf{24.} fake\_followers\_words\_score.
	
	\item[\PencilRight]750 words in the Safe Area - overall ranking placement\\
	\textbf{6.} news\_spreaders\_words\_score, \textbf{9.} NSFW\_words\_score, \textbf{14.} spam\_bots\_words\_score, \textbf{25.} fake\_followers\_words\_score.
...
\begin{figure}[htp!]
	...
	\caption{Features ranking - overall view}
	\label{fig:250_overall}
	\includegraphics[width=\columnwidth]{chapter4/figure/features_importances_250_closeup.png}
	\caption{Features ranking - close-up view}
	\label{fig:250_closeup}
\end{figure}
\begin{figure}{}
	\includegraphics[width=\columnwidth]{chapter4/figure/features_importances_500.png}\par 
	\caption{Features ranking - overall view}
	\label{fig:500_overall}
	\includegraphics[width=\columnwidth]{chapter4/figure/features_importances_500_closeup.png}\par 
	\caption{Features ranking - close-up view}
	\label{fig:500_closeup}
\end{figure}
\begin{figure}{}
	\includegraphics[width=\columnwidth]{chapter4/figure/features_importances_750.png}\par 
	\caption{Features ranking - overall view}
	\label{fig:750_overall}
	\includegraphics[width=\columnwidth]{chapter4/figure/features_importances_750_closeup.png}\par 
	\caption{Features ranking - close-up view}
	\label{fig:750_closeup}
\end{figure}
\begin{figure}{}
	\includegraphics[width=\columnwidth]{chapter4/figure/features_importances_1000.png}\par 
	\caption{Features ranking - overall view}
	\label{fig:1000_overall}
	\includegraphics[width=\columnwidth]{chapter4/figure/features_importances_1000_closeup.png}\par 
	\caption{Features ranking - close-up view}
	\label{fig:1000_closeup}
\end{figure}
